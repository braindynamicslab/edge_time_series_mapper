...
for subject = subjects
    ...
    output_filename = sprintf("simplexMapper_%s_%d_%s_%s_peak_dense_pure_nodes_purity_%d_peak_density_%d_edgeAlpha_%d", simplex, subject, session, parcellation, purity_threshold * 100, peak_density_threshold * 100, edge_alpha * 100);
