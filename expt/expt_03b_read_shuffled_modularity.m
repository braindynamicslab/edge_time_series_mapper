...
for cohort = cohorts
    for simplex = simplices
        ...
        for purity_threshold = purity_thresholds
            ...
            for peak_density_threshold = peak_density_thresholds
                ...
                for subject_idx = 1:num_subjects
                    ...
                    if isfile(shuffled_file)
                        ...
                        result_table.(matched_random_na_col)(subject_idx) = sum(isnan(shuffled_data.matched_random_nodes));
            ...
            % Save output file
            output_filename = sprintf('shuffled_modularity_mean_%s_%s_%s_peak_%d_purity_%d.csv', ...
                simplex, cohort, session, round(100*peak_threshold), round(100*purity_threshold));
