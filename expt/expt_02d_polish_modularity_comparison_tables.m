...
process_paired_ttest_table(input_file_1, output_file_1);
...
process_covariate_adjustment_table(input_file_2, output_file_2);
...
function process_paired_ttest_table(input_file, output_file)
    % Read data
...
function process_covariate_adjustment_table(input_file, output_file)
    % Read data
    fprintf('Reading input file...\n');
    data = readtable(input_file, "TextType", "string", ...
                     "VariableNamingRule", "preserve");
    ...
    numerical_cols = ["coefficient", "standard_error", "t_statistic", ...
                      "p_value"];
