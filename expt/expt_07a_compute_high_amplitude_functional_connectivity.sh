#!/bin/bash
#SBATCH --job-name=expt_07a_compute_high_amplitude_functional_connectivity
#
# RESOURCE ALLOCATION
...
expt_07a_compute_high_amplitude_functional_connectivity;"
...
if [ $? -eq 0 ] ; then
    echo "Successfully ran expt_07a_compute_high_amplitude_functional_connectivity"
else
