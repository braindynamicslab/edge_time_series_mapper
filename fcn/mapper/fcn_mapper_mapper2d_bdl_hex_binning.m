...
%
function [adja, adja_pruned, pts_in_vertex, pts_in_vertex_pruned] = fcn_mapper_mapper2d_bdl_hex_binning(distMat, filter_values, num_intervals, percent_overlap, num_bins_clustering, nsides)
