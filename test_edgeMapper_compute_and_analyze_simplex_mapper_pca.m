...
simplex = "edge";
dim_reduction_type = "pca_explained_variance";
...
if compute_flag
    debug_filename = fullfile(output_directory, sprintf("test_compute_and_analyze_simplex_mapper_100206_%s_%s_mapper_input.mat", simplex, ));
    fcn_edgeMapper_compute_and_analyze_simplex_mapper(subject, parcellation, session, simplex, output_directory, "mapper_auto_tune_flag", mapper_auto_tune_flag, "mapper_params", mapper_params, "debug_flag", 1, "debug_filename", debug_filename);
